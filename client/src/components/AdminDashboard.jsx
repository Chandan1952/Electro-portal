...
const BASE_URL = "https://electro-portal-backend.onrender.com"; // Backend URL
    ...
    const fetchStats = async () => {
      try {
        ...
        const formattedStats = [
          { title: "Reg Users", count: fetchedStats.regUsers || 0, color: "#1E3A8A" },
          { title: "Listed Vehicles", count: fetchedStats.listedVehicles || 0, color: "#10B981" },
          { title: "Total Bookings", count: fetchedStats.totalBookings || 0, color: "#3B82F6" },
          { title: "Listed Brands", count: fetchedStats.listedBrands || 0, color: "#F97316" },
          { title: "Subscribers", count: fetchedStats.subscribers || 0, color: "#1D4ED8" },
          { title: "Queries", count: fetchedStats.queries || 0, color: "#047857" },
          { title: "Testimonials", count: fetchedStats.testimonials || 0, color: "#2563EB" },
        ];
